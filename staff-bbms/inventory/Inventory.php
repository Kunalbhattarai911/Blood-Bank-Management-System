...
<body1>
    ...
    <div>
        <form action="inventory.php" method="post">
            ...
            <label for="available_units">Add Blood Units:</label>
            <input type="number" id="available_units" name="available_units" required><br><br>
            <input type="submit" value="Submit">
        </form>
    </div>
    <div class="para">
        <p>To access the blood inventory table, please click on "Inventory" below.</p><br>
    </div>
    <button><a href="inventorylist.php" style="color: inherit; text-decoration: none;">Inventory</a></button>
