...
<head>
    ...
    <style>
        ...
        .completed {
            background-color: #8BC34A; /* Green color for completed tasks */
            color: white;
        }
        .Not-completed {
            background-color: #ff0000; /* Red color for not completed tasks */
            color: white;
        }
        .list{
            background-color: #2c3e50;
...
<div class="containers">
    ...
    <form action="appointment.php" method="post">
        ...
        <div class="form-group">
            ...
            <input type="number" id="age" name="age" required oninput="validateAge(this)">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="tel" id="contact_number" name="contact_number" required oninput="validateContactNumber(this)">
        </div>
        <div class="form-group">
    ...
    <div class="appointment-list">
        <p>To access the list of appointments, please click the list below.</p>
        <br>
        <a href="appointment_list.php" class="list">list</a>
    </div>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            form.addEventListener('submit', function (event) {
                if (!validateContactNumber(contactNumberInput.value)) {
                    alert('Please enter a valid contact number (up to 10 digits).');
            ...
            function validateContactNumber(contactNumber) {
                return /^\d{1,10}$/.test(contactNumber);
            }
